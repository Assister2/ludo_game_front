    ...
    <div className=" col-12 col-sm-12 col-md-6 col-lg-4 mx-auto p-3 g-0">
      <div className="d-flex flex-column align-items-stretch justify-content-start">
        ...
        <div className="d-flex flex-column align-items-stretch">
          <a
            href="whatsapp://send/?phone=917726908042&amp;text=I+have+an+issue.+Please+Help+Me+&amp;app_absent=0"
            className="text-decoration-none text-white w-100"
            target="blank"
          >
            <button className="btn btn-success btn-lg mb-3 d-flex align-items-center justify-content-center w-100">
              <div className="hstack gap-2 minBreakpoint-xs">
                ...
                <span className="text-capitalize">Contact on Whatsapp</span>
              </div>
            </button>
          </a>
        </div>
          ...
          >
            ...
            >
              <div className="hstack gap-2 minBreakpoint-xs">
                ...
                <span className="text-capitalize">Connect on Instagram</span>
              </div>
            </button>
          </a>
        </div>
          ...
          >
            <button className="btn btn-outline-primary btn-lg d-flex align-items-center justify-content-center w-100">
              <div className="hstack gap-2 minBreakpoint-xs">
                ...
                <span className="text-capitalize">Reach Us Via Email</span>
              </div>
            </button>
          </a>
        </div>
